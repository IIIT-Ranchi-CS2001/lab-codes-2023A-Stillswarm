# Write a python script to Form a list of K random numbers within a limit N where K and N are set by the user.
# Minimum value of K should be 10. Define a function (or two functions) to return the composite numbers and prime
# numbers of this list as two separate lists. Determine the square of all prime numbers and square root of all
# composite numbers Plot both prime numbers Vs their squares and composites Vs their square roots on the same figure
# object as scatter plots. ( two different subplots on the same figure object)
