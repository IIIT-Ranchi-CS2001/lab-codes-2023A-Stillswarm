# Q1 Show party wise seat share for following results of the Assembly Elections 2023 in Two different pie charts on
# two different plots. Party with the highest percentage should be shown as slightly detached ( show the percentage seat
# share on each wedge ) Two pie charts as subplots on the same figure object As a bar chart with party name on X axis
# and seats won on y-axis. Show results of both the states on the same bar plot. Give proper legends Madhya Pradesh
# BJP - Win (163) INC - Win (66) BSP – Win ( 0) Others – Win (1) Rajasthan INC - Win (69) BJP- Win (115) BSP- Win (2)
# Others-Win (13)
